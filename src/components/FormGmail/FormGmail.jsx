...
const FormGmail = () => {
  return (
    <div className='form-hair flex justify-center items-center mt-[9.8em]'>
        <img className='gmail relative left-[11em] bottom-[8.5em]' src={gmail} alt="" />
        <div className='form-cont border-[3px] border-[#373737] max-w-[984px] max-h-[269px]'>
            <div className='main-title pt-[3em]'>
            <h1 className='title-one pl-[3.1em] font-Montserrat font-bold text-[28px] text-[#373737]'>Одно письмо с</h1>
            <h1 className='title-two pl-[3.1em] font-Montserrat font-bold text-[28px] text-[#373737]'>лучшими</h1>
            <h1 className='title-three  pl-[3.1em] font-Montserrat font-bold text-[28px] text-[#373737]'>материалами за</h1>
            <h1 className='title-four pl-[3.1em] font-Montserrat font-bold text-[28px] text-[#373737]'>неделю</h1>
            </div>
            <div className='form-sub float-left ml-[25em] mt-[-10.5em]'>
                ...
                <div className='form-content pt-[1.5em] flex'>
                    ...
                    <button className='form-button border-[2px] border-[#373737] w-[149px] h-[42px] rounded-[4px]'>
                        <h5 className='ml-[-1.5em] mt-2 font-Montserrat font-medium text-[16px] text-[#373737]'>Отправить</h5>
                        <img className='more relative bottom-[1.2em] left-[7.5em]' src={moreicons} alt="" />
                    </button>
                    
                    </div>
                </div>
               <div className='pag-blabla flex mt-[1em]'>
