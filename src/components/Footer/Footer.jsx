...
const Footer = () => {
  return (
    <footer className='footer bg-[#EDEDED] w-full relative top-[171em] px-[6.4em] py-[3em]'>
        <div className='footer-one flex'>
            <img src={logofooter} alt="" />
            <p className='pl-[2em] font-Montserrat font-medium text-[12px] text-[#373737]'>Инновационные решения для <br /> восстановления, питания и уходу за <br /> волосами головы, бровей и бороды</p>
        </div>
